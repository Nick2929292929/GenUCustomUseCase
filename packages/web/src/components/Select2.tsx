    ...
    <RowItem notItem={props.notItem} className="relative">
      ...
      <Listbox value={props.value} onChange={props.onChange}>
        <div className="relative">
          <Listbox.Button
            className={`relative h-8 cursor-pointer rounded border border-black/30 bg-white pl-3 pr-10 text-left focus:outline-none text-xs ${props.fullWidth ? 'w-full' : 'w-fit'}`}>
